...
public class PropertySet(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE) {
    public fun getValue(): PropertySet = PropertySet(pointer.getPointer(0))

    public fun setValue(`value`: PropertySet): Unit {
  ...
  public object ABI {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Foundation.Collections.PropertySet".toHandle(),refiid,iAFPtr)
      checkHR(hr)
