...
public class DtdNotation(
...
) : PointerType(ptr), IDtdNotation, IXmlNode, IXmlNodeSerializer, IXmlNodeSelector, IWinRTObject {
  public val IDtdNotation_Interface: IDtdNotation by lazy {
    asIDtdNotation()
  }
  ...
  public override val IDtdNotation_Ptr: Pointer? by lazy {
    IDtdNotation_Interface.IDtdNotation_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(IDtdNotation_Interface, IXmlNode_Interface, IXmlNodeSerializer_Interface,
        IXmlNodeSelector_Interface)

  private fun asIDtdNotation(): IDtdNotation {
    if(pointer == Pointer.NULL) {
      return(IDtdNotation.ABI.makeIDtdNotation(Pointer.NULL))
    }
    val refiid = Guid.REFIID(IDtdNotation.ABI.IID)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE) {
    public fun getValue(): DtdNotation = DtdNotation(pointer.getPointer(0))
