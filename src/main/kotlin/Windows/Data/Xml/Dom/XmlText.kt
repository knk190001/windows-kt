...
public class XmlText(
...
) : PointerType(ptr), IXmlText, IXmlCharacterData, IXmlNode, IXmlNodeSerializer, IXmlNodeSelector,
    IWinRTObject {
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(IXmlText_Interface, IXmlCharacterData_Interface, IXmlNode_Interface,
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE) {
    public fun getValue(): XmlText = XmlText(pointer.getPointer(0))
