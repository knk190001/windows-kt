...
public class XmlDocumentFragment(
...
) : PointerType(ptr), IXmlDocumentFragment, IXmlNode, IXmlNodeSerializer, IXmlNodeSelector,
    IWinRTObject {
  public val IXmlDocumentFragment_Interface: IXmlDocumentFragment by lazy {
    asIXmlDocumentFragment()
  }
  ...
  public override val IXmlDocumentFragment_Ptr: Pointer? by lazy {
    IXmlDocumentFragment_Interface.IXmlDocumentFragment_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(IXmlDocumentFragment_Interface, IXmlNode_Interface,
        IXmlNodeSerializer_Interface, IXmlNodeSelector_Interface)

  private fun asIXmlDocumentFragment(): IXmlDocumentFragment {
    if(pointer == Pointer.NULL) {
      return(IXmlDocumentFragment.ABI.makeIXmlDocumentFragment(Pointer.NULL))
    }
    val refiid = Guid.REFIID(IXmlDocumentFragment.ABI.IID)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE) {
    public fun getValue(): XmlDocumentFragment = XmlDocumentFragment(pointer.getPointer(0))
